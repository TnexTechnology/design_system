...
class _DropdownButtonExampleState extends State<DropdownButtonExample> {
  ...
  final List<ColorModel> list = [
      ...
      ColorModel(name: "grey 900", color: TnexColor.gray900),
      ColorModel(name: "grey 800", color: TnexColor.gray800),
      // ColorModel(name: "grey 700", color: TnexColor.gray700),
      // ColorModel(name: "grey 600", color: TnexColor.gray600),
